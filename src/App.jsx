...
const emailData = [
  // --- 10 SERIÖSE E-MAILS ---
  {
    ...
    type: 'legit',
    explanation:
      'Eine seriöse Adresse der Schule (ws-staat.muenchen.musin.de). Der Inhalt ist plausibel.',
  },
  {
    id: 104,
  ...
  },
  {
    ...
    type: 'legit',
    explanation:
      'Seriöse Erinnerung einer offiziellen Institution (.de Domain).',
  },
  {
    id: 110,
  ...
  },
  {
    ...
    type: 'legit',
    explanation:
      'Eine typische Info-Mail einer Lehrkraft mit der korrekten Domain der Schule.',
  },
  {
    id: 112,
    ...
    type: 'legit',
    explanation:
      'Echte Info-Mail. Sie kündigt eine Wartung an, verlangt aber kein Passwort. Die Domain ist korrekt.',
  },
  {
    id: 113,
    ...
    type: 'legit',
    explanation:
      "Eine typische, seriöse Bestellbestätigung. Die Domain 'amazon.de' ist korrekt.",
  },
  {
    id: 114,
    ...
    type: 'legit',
    explanation:
      "Eine echte Benachrichtigung von Instagram. Die Domain 'instagram.com' ist korrekt.",
  },
  {
    id: 115,
  ...
  },
  {
    ...
    type: 'legit',
    explanation:
      "Standard-Newsletter eines bekannten Dienstes mit korrekter Domain 'spotify.com'.",
  },
  ...
  // --- 10 SPAM/PHISHING E-MAILS ---
  {
    ...
    type: 'spam',
    explanation:
      "Phishing! Achte auf die Endung '.cn' (China) statt '.com'. Banken drohen nie mit sofortiger Löschung.",
  },
  {
    id: 101,
    ...
    type: 'spam',
    explanation:
      "Klassischer Paket-Betrug. Die URL 'dhl-track-delivery-status.net' gehört nicht zu DHL.",
  },
  {
    id: 102,
    ...
    type: 'spam',
    explanation:
      "Der 'CEO-Fraud'. Der Name stimmt, aber die Adresse ist eine private Gmail-Adresse, nicht die Schul-Adresse!",
  },
  {
    id: 103,
    ...
    type: 'spam',
    explanation:
      "Druckaufbau und Drohung. Die Domain '.tk' (Tokelau) wird oft für Gratis-Domains und Spam genutzt.",
  },
  {
    id: 105,
    ...
    type: 'spam',
    explanation:
      "Der 'Tech Support Scam'. Microsoft schickt keine E-Mails über Virenfunde.",
  },
  {
    id: 106,
    ...
    type: 'spam',
    explanation:
      "Typosquatting: Schau genau hin! Da steht 'netfl1x' (mit Eins statt I).",
  },
  {
    id: 107,
    ...
    type: 'spam',
    explanation:
      'Niemand verschenkt Geld. Die Domain .xyz ist typisch für Spam.',
  },
  {
    id: 108,
    senderName: 'Lisa22',
    ...
    type: 'spam',
    explanation:
      'Bot-Spam. Unbekannte Absender mit Domains wie .biz wollen dich auf kostenpflichtige Portale locken.',
  },
  {
    id: 117,
    ...
    type: 'spam',
    explanation:
      "Betrug! Man muss nie für einen echten Gewinn 'Gebühren' im Voraus zahlen. Domain .info ist verdächtig.",
  },
  {
    id: 118,
    senderName: 'Dropbox',
    ...
    type: 'spam',
    explanation:
      "Phishing. Die Domain endet auf '.com.co' (Kolumbien), nicht nur '.com'. Sie wollen dein Dropbox-Passwort stehlen.",
  },
];
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center animate-in zoom-in duration-300">
        ...
        <h2 className="text-3xl font-bold text-slate-800 mb-2">
          E-Mail Detektiv Training
        </h2>
        <p className="text-slate-500 mb-8">
          Bitte gib deinen Namen und deine Klasse ein, um zu starten.
        </p>
...
function GameOverScreen({
  ...
  const getFeedbackMessage = () => {
    ...
    if (percentage === 100)
      return 'Perfekt! Du bist ein Cyber-Security Experte! 🛡️';
    if (percentage >= 80) return 'Sehr gut! Du erkennst fast jeden Betrug. 👀';
    if (percentage >= 60)
      return 'Guter Anfang, aber pass bei verdächtigen Links auf. ⚠️';
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center animate-in zoom-in duration-300">
        ...
        <h2 className="text-3xl font-bold text-slate-800 mb-2">
          Posteingang bereinigt!
        </h2>
        <p className="text-slate-500 mb-6">
          Gute Arbeit, {userName}. Hier ist dein Ergebnis:
        </p>
        ...
        <div className="bg-slate-50 rounded-xl p-6 mb-8 border border-slate-100">
          ...
          <div className="text-5xl font-bold text-blue-600">
            {correctCount}{' '}
            <span className="text-3xl text-slate-400">/ {totalMails}</span>
          </div>
    ...
    <div className="h-screen bg-slate-100 flex flex-col font-sans overflow-hidden text-slate-800">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col">
          <div className="p-4">
            <button className="w-full bg-blue-50 text-blue-700 font-bold py-3 px-4 rounded-lg flex items-center gap-3 mb-6 border border-blue-100 shadow-sm">
              <Inbox size={18} /> Posteingang{' '}
            ...
            <div className="space-y-1">
              <div className="text-xs font-bold text-slate-400 uppercase px-4 mb-2 tracking-wider">
                Ordner
              </div>
              {[
                'Posteingang',
                ...
                <div
                  key={folder}
                  className={`px-4 py-2 rounded-md flex items-center gap-3 text-sm font-medium ${
                    idx === 0
                      ? 'bg-slate-100 text-blue-600'
                      : 'text-slate-500 hover:bg-slate-50 cursor-not-allowed opacity-70'
                  }`}
                >
                  {idx === 0 ? (
                    <Inbox size={16} />
          ...
          <div className="mt-auto p-4 border-t border-slate-100">
            <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-3 text-xs text-yellow-800">
              <div className="font-bold flex items-center gap-1 mb-1">
                <Lock size={12} /> Tipp des Tages:
              </div>
              Prüfe immer die Absender-Adresse, nicht nur den Namen!
            </div>
            <p className="text-xs text-slate-400 text-center mt-3">
              &copy; Jonathan Mangold
            </p>
          </div>
        </aside>

        {/* Email List */}
        <div className="w-full md:w-80 lg:w-96 bg-white border-r border-slate-200 flex flex-col z-0">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200">
            {emails.map((email) => (
              ...
              >
                ...
                <div className="text-xs text-slate-400 truncate font-serif">
                  {email.body.split('\n')[0]}
                </div>
              </div>
            ))}
        ...
        {/* Reading Pane */}
        <main className="flex-1 bg-slate-50 flex flex-col relative overflow-hidden min-w-0">
          {selectedEmail ? (
            <>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      ...
                      <div
                        className={`absolute top-full left-0 mt-2 bg-slate-800 text-white text-xs p-3 rounded-lg shadow-xl w-72 z-50 transition-all duration-200 ${
                          showHint
                      ...
                      >
                        ...
                        Schaue dir die Domain (das nach dem @) genau an. Passt
                        sie zum Absender? Achte auf Rechtschreibfehler oder
                        komische Endungen.
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-4 bg-slate-100 border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                {!feedback ? (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <div className="text-center md:text-left">
                          ...
                          <div className="text-xs font-normal opacity-70 hidden md:block">
                            Das ist Spam / Betrug
                          </div>
                        </div>
                      </button>
                  ...
                  /* Feedback State */
                  <div
                    className={`rounded-xl p-5 border-2 flex flex-col md:flex-row items-center md:items-start gap-4 shadow-lg animate-in slide-in-from-bottom-4 fade-in duration-300 max-w-3xl mx-auto ${
...
export default function EmailDetectivePro() {
  ...
  const resetGame = () => {
    ...
    setSelectedEmailId(selectedSet[0]?.id || null); // Sicherstellen, dass es eine ID gibt
    setScore(0);
  ...
  const handleLogin = (name, klasse) => {
    ...
    setEmails(selectedSet);
    setSelectedEmailId(selectedSet[0]?.id || null);
    setScore(0);
    setCorrectCount(0);
    setProcessedCount(0);
    setFeedback(null);
  ...
  const handleDownloadPDF = () => {
    ...
    doc.setFontSize(12);
    doc.text(
      `- Korrekt erkannt: ${correctCount} von ${processedCount} E-Mails`,
      20,
      80
    );
